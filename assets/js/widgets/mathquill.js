 ...
 */
 ...
 (function() {
    ...
    // Edit
    LatexCmds.dot = bind(Style, '\\dot', 'span', 'class="mq-non-leaf mq-dot"');
    ...
    var Bracket = P(P(MathCommand, DelimsMixin), function(_, super_) {
      ...
      _.latex = function() {
        ...
        return ''+this.sides[L].ctrlSeq+this.ends[L].latex()+''+this.sides[R].ctrlSeq;
      };
    ...
    */
    ...
    // CharCmds['*'] = LatexCmds.sdot = LatexCmds.cdot =
        // bind(BinaryOperator, '\\cdot ', '&times;', '*');
    ...
    // Edit le & ge => leq && geq
    var less = { ctrlSeq: '\\leq', html: '&le;', text: '\u2264',
                 ctrlSeqStrict: '<', htmlStrict: '&lt;', textStrict: '<' };
    var greater = { ctrlSeq: '\\geq', html: '&ge;', text: '\u2265',
                    ctrlSeqStrict: '>', htmlStrict: '&gt;', textStrict: '>' };
    ...
    // Edit
    LatexCmds['\u00d7'] = CharCmds['*'] = LatexCmds.times = bind(BinaryOperator, '\\times ', '&times;', '[x]');
